const express = require("express"); // le todo o arquivo
const { Client } = require('pg'); // so um pedaço "client" 
...
app.get("/", (req, res) => {
    console.log("Response ok."); //powershell
    res.send("Ok – Servidor disponível."); //browser
});
